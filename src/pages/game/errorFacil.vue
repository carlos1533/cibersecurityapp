        ...
        responses: [
          {
            ...
            isAnswer: false,
            recommendation:
              "Nunca compartas tus contraseñas con nadie, recuerda que las contraseñas son privadas y personales."
          },
          {
            text:
        ...
        responses: [
          {
            ...
            isAnswer: true,
            recommendation:
              "Usa contraseñas robustas y diferentes para cada cuenta y porsupuesto no la compartas con nadie"
          },
          {
            text:
        ...
        responses: [
          {
            ...
            isAnswer: true,
            recommendation:
              "Evita utilizar información personal, como nombres, fecha de cumpleaños, nombre de mascota en tus contraseñas, ya que es algo que la mayoria conoce y  podrían adivinar tu contraseña."
          },
          {
            text:
        ...
        responses: [
          {
            ...
            isAnswer: true,
            recommendation:
              "Las contraseña deben ser dificil de averiguar, secretas y se deben cambiar de vez en cuando."
          },
          {
            text:
        ...
        responses: [
          {
            ...
            isAnswer: true,
            recommendation:
              "Proteger tu dispositivo te evitará muchos problemas !BlOQUEA TU SMARTPHONE!"
          },
          {
            text:
